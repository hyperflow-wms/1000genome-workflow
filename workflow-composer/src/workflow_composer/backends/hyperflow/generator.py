...
from ...core.environment import ComputeEnvironment
from ...core.parallelism import Parallelism, format_parallelism_reason, recommend_parallelism

logger = logging.getLogger(__name__)

# Bundled population files directory
BUNDLED_POPULATIONS_DIR = Path(__file__).parent.parent.parent / "data" / "populations"
